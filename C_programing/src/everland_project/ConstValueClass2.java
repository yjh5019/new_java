...
//		Locale currentlocale = new Locale("es","ES");
		...
		TICKET_TYPE_NIGHT = messages.getString("TICKET_TYPE_NIGHT");
		PRINT_JUMIN_NUM = messages.getString("PRINT_JUMIN_NUM");
		HOW_MANY_TICKET = messages.getString("HOW_MANY_TICKET");
		SELECT_UDAE = messages.getString("SELECT_UDAE");
		SELECT_UDAE_1 = messages.getString("SELECT_UDAE_1");
		SELECT_UDAE_2 = messages.getString("SELECT_UDAE_2");
		SELECT_UDAE_3 = messages.getString("SELECT_UDAE_3");
		SELECT_UDAE_4 = messages.getString("SELECT_UDAE_4");
		SELECT_UDAE_5 = messages.getString("SELECT_UDAE_5");
		PRICE_OUTPUT_1 = messages.getString("PRICE_OUTPUT_1");
		PRICE_OUTPUT_2 = messages.getString("PRICE_OUTPUT_2");
		PRICE_THANKS = messages.getString("PRICE_THANKS");
		PRICE_KEEP_TICKET = messages.getString("PRICE_KEEP_TICKET");
		KEEP_GOING = messages.getString("KEEP_GOING");
		STOP = messages.getString("STOP");

		PRINT_EVERLAND = messages.getString("PRINT_EVERLAND");
		PRINT_JUGAN = messages.getString("PRINT_JUGAN");
		PRINT_YAGAN = messages.getString("PRINT_YAGAN");

		AGE_TYPE_ADULT = messages.getString("AGE_TYPE_ADULT");
		AGE_TYPE_TEEN = messages.getString("AGE_TYPE_TEEN");
		AGE_TYPE_CHILD = messages.getString("AGE_TYPE_CHILD");
		AGE_TYPE_OLD = messages.getString("AGE_TYPE_OLD");
		AGE_TYPE_INFANT = messages.getString("AGE_TYPE_INFANT");

		PRINT_UDAE_NONE = messages.getString("PRINT_UDAE_NONE");
		PRINT_UDAE_Disabled = messages.getString("PRINT_UDAE_Disabled");
		PRINT_UDAE_MenofNationalMerit = messages.getString("PRINT_UDAE_MenofNationalMerit");
		PRINT_UDAE_MultipleChildren = messages.getString("PRINT_UDAE_MultipleChildren");
		PRINT_UDAE_PregnantWoman = messages.getString("PRINT_UDAE_PregnantWoman");
