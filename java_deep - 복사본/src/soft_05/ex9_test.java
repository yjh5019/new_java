...
public class ex9_test {
	...
	public static void main(String[] args) {
		...
		/////////////////////////////////////////////
		//물품 항목
		String[] k37_itemname = {"부대찌개","김치찌개aa유유유","삶은계란","오렌지주스","초코에몽",
				"1진비빔면가가가","농심 신라면 39431g 이벤트","샌드위치맛있arjt","상투과자","들깨미역국",
							"딸기파이","초코우유1유유유유유유","포도","사과주스","딸기에몽",
							"닭가슴살","프로틴","샴푸","린스","입욕제",
							"바나나파이","새로운딸기우유(renew)","딸기우유","포도주스","삼겹살",
